...
#define CONFIG_MACH_SIGMA_MONZA
#define CONFIG_MACH_SIGMA_SX6
#define CONFIG_SIGMA_TRIX_NAME	"SX6"
#define CONFIG_SIGMA_NR_UMACS	2
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
    ...
    "check_bmode=if itest.s ${bootmode} == normalmode; then "   \
