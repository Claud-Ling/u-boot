...
RMuint32 _gbus_fifo_get_readable_size(struct gbus *pgbus, struct gbus_fifo *fifo, RMuint32 *rd_ptr1, RMuint32 *rd_size1, RMuint32 *rd_ptr2, RMuint32 entry_size)
{
	RMuint32 base, size, rd, wr;
